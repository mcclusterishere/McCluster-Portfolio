/* MCC_HOUSE — the shelf where the house pays YOU.
   Real services priced in E-Up credit: stack the ᴹ, pay the house,
    ...
    Promise.all([offers(), balance()]).then(function (r) {
      ...
      rows.forEach(function (o) {
        ...
        card.innerHTML =
          ...
          (+o.price).toFixed(0) + ' <span style="font-size:0.9rem">ᴹ</span>' +
        ...
        if (bal === null) {
          ...
          b.textContent = "Claim it — pay the house " + (+o.price).toFixed(0) + " ᴹ";
          ...
          act.innerHTML =
            ...
            " ᴹ — " + short + " short.</b> Stack the rest: claim your bankroll on the desk, run " +

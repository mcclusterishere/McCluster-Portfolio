...
(function () {
  ...
  var TIPS = [
    ...
    "Ask me how <b>T.R.A.P.S.</b> pays up to 1,000 E⤴︎.",
  ...
  function restore() {
    ...
    S.token().then(function (t) {
      ...
      body.innerHTML = "";
      if (!rows || !rows.length) {
        bubble("I'm the Guide — I know every corner of this platform. Ask me how E⤴︎ works, how to run T.R.A.P.S., how the plug pays, how to climb the civic ladder… or just tell me what you're trying to do.", "ai");
        return;
      }
